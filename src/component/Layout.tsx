import { Button, Card, Popover, PopoverContent, PopoverTrigger, Spinner, Switch } from '@nextui-org/react';

import { useAtom, useAtomValue } from 'jotai';
import { Suspense } from 'react';
import { appStore } from '../store';
import { designerAtom } from '../store/designer';
import { drawingSchemaIdAtom, setDrawingSchemaAtom } from '../store/schema';
